...
namespace ContractMAnagmentSystem {
    ...
    public partial class CRUD_DBDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FullName, string Gender, string PhoneNumber, string Email, string Address) {
...
namespace ContractMAnagmentSystem.CRUD_DBDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`Employee_ID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`FullName`, `PhoneNumber`, `Email`, `Address`) VALUES (?" +
                ", ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `FullName` = ?, `PhoneNumber` = ?, `Email` = ?, `Address` = ? WHERE ((`Employee_ID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ContractMAnagmentSystem.Properties.Settings.Default.CRUD_DBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Employee_ID, FullName, PhoneNumber, Email, Address FROM Employees";
        ...
        public virtual int Fill(CRUD_DBDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual CRUD_DBDataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CRUD_DBDataSet.EmployeesDataTable dataTable = new CRUD_DBDataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CRUD_DBDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Employee_ID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address) {
        ...
        public virtual int Update(string FullName, string PhoneNumber, string Email, string Address, int Original_Employee_ID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address) {
            if ((FullName == null)) {
